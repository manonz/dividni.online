...
const apiUrl = "https://redsox.uoa.auckland.ac.nz/duc/Converter";
...
function downLoadCodeBase(data, endpoint) {
  if (completeFormValid !== 1) {
    updateStatus(false, "Form errors. Please correct errors and try again.");
    return;
  }

  const ccElement = document.getElementById("downloadCode");
  ...
  fetch(`${apiUrl}/${endpoint}`, {
    ...
    .then((data) =>{
      let code = data;
      let fileName = getSanitisedValue(document.getElementById("questionName")) ||
      "AutoGeneratedQ";
      fileName += ".cs";
